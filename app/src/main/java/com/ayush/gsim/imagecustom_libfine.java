...
public class imagecustom_libfine extends ArrayAdapter<String>{
private final Activity context;
private final String[] web;
private final String[] web1;
public imagecustom_libfine(Activity context,
...
View rowView= inflater.inflate(R.layout.imagecustomlibfine, null, true);
