...
public class ImageCustomSubjectAttendance extends ArrayAdapter<String> {
    ...
    public ImageCustomSubjectAttendance(Activity context,
                                        String[] web, String[] web1, String[] web2, String[] web3, String[] web4) {
        super(context, R.layout.imagecustom_subjectwise, web);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.imagecustom_subjectwise, null, true);
