...
import com.ayush.gsim.ImageCustoms.ImageCustomLibraryFine;
import com.ayush.gsim.ImageCustoms.ImageCustomLibraryIssue;
...
public class LibraryFragment extends Fragment {
	...
	*/
                ...
                ImageCustomLibraryFine ic = new ImageCustomLibraryFine(getActivity(), con1, con2);
                //list.setAdapter(ic);
                list.setAdapter(ic);
            } else {
                rootView = inflater.inflate(R.layout.listview,
                ...
                if (book_issue_title.length > 0) {
                    ImageCustomLibraryIssue ic = new ImageCustomLibraryIssue(getActivity(), book_issue_title, book_issue_date, book_due_date, book_return_date);
                    //list.setAdapter(ic);
                    list = (ListView) rootView.findViewById(R.id.listView1);
                    list.setAdapter(ic);
                } else {
