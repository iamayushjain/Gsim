...
public class DeveloperContactPage extends Fragment {
    public static DeveloperContactPage newInstance() {
        return new DeveloperContactPage();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle args) {
        ...
        view1 = inflater.inflate(R.layout.developer_layout, container, false);
        TextView t1, t2, t3, t4;
        final ImageView zoomoutpic = (ImageView) view1.findViewById(R.id.imageView1);
        zoomoutpic.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                zoomImageFromThumb(zoomoutpic, R.drawable.developer_pic);
            }
        });
    ...
    public void zoomImageFromThumb(final View thumbView, int imageResId) {
        ...
        view1.findViewById(R.id.outLayout)
