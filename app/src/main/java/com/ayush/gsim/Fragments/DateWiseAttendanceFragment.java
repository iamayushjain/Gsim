...
public class DateWiseAttendanceFragment extends Fragment {
    ...
    public static final String TAG = DateWiseAttendanceFragment.class.getSimpleName();
    ...
    public static DateWiseAttendanceFragment newInstance() {
        return new DateWiseAttendanceFragment();
    }
