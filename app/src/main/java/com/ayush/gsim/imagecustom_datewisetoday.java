...
public class imagecustom_datewisetoday extends ArrayAdapter<String>{
...
public imagecustom_datewisetoday(Activity context,
...
public View getView(int position, View view, ViewGroup parent) {
    ...
    View rowView = inflater.inflate(R.layout.imagelayout_datetoday, null, true);
