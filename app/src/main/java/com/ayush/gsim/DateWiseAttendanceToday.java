...
public class DateWiseAttendanceToday extends Fragment{
	...
	public static final String TAG = DateWiseAttendanceToday.class.getSimpleName();
	...
	public static DateWiseAttendanceToday newInstance() {
		return new DateWiseAttendanceToday();
	}
