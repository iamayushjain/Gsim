 ...
 */
public class ArchivePadListAdapter extends FirebaseListAdapter<ArchivePad> {
    ...
    public ArchivePadListAdapter(Query ref, Activity activity, int layout) {
        super(ref, ArchivePad.class, layout, activity);
    ...
    @Override
    protected void populateView(View view, final ArchivePad archivePad) {
        // Map a ArchivePad object to an entry in our listview
//        String author = archivePad.getAuthor();
//        view1 = view;
...
//        final String authorUrl = archivePad.getAuthorUrl();
...
//            authorText.setTextColor(activity.getResources().getColor(R.color.primaryColor));
//        }
//        //   Url = archivePad.getAuthor().toString();
//
//        TextView messageText = ((TextView) view.findViewById(R.id.textView2));
//        messageText.setTypeface(Typeface
//                .createFromAsset(activity.getAssets(), "robotothin.ttf"));
//        try {
//            messageText.setText(Html.fromHtml(checkFacebookIntent(archivePad.getMessage())));
...
//        final String url = archivePad.getUrl();
//        final String phone = archivePad.getPhone();
...
//            }
//        });
//        String imageUrl = archivePad.getImageUrl();
...
//                android.R.integer.config_shortAnimTime);
        ...
        TextView semesterText = (TextView) view.findViewById(R.id.semesterText);
        nameText.setTextColor(activity.getResources().getColor(R.color.primaryColor));
        ...
        semesterText.setTypeface(Typeface
                .createFromAsset(activity.getAssets(), Constants.FONT_ROBOTO_THIN));
        nameText.setText(archivePad.getName());
        yearText.setText("Session: " + archivePad.getSession());
        LogWrapper.out(activity.getApplicationContext(), archivePad.getLink());
        semesterText.setText(archivePad.getSemester());
        ...
        downloadButton.setColorFilter(R.color.colorPrimary);
        url = archivePad.getLink();
    ...
    public String checkFacebookIntent(String url) {
        ...
        try {
            ...
            return url.replace("fb://facewebmodal/f?href=", "");
        }
    }
