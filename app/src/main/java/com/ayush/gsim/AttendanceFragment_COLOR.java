...
public class AttendanceFragment_COLOR extends Fragment {
    TextView text;
    TextView view1;
    ...
    public static final String TAG = AttendanceFragment_COLOR.class.getSimpleName();
    ...
    public static AttendanceFragment_COLOR newInstance() {
        return new AttendanceFragment_COLOR();
